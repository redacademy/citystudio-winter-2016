	...
	<div class="section-credits content-wrapper">
      ...
      <div class="col-one">
        <span class="proj-partners proj-detail-wrap">
          <h3>School &amp; Course:</h3>
			     	<p>
              <?php the_field('participating_school');
				        if (have_rows('course_name'));
        ...
        <span class="proj-faculty proj-detail-wrap">
          ...
          <p>
            ...
            <?php the_field('semester_completed'); ?> -
  					<?php the_field('year_completed'); ?>     
          </p>
				</span>
				<span class="proj-subtitle proj-detail-wrap">
					<h3>City Strategy &amp; Goal Area: </h3>
					<p>
            <?php the_field('city_strategy'); ?> -
					  <?php the_field('goal_area'); ?>     
          </p>
				</span>
				<span class="proj-subtitle proj-detail-wrap">
				  <h3>Neighbourhood:</h3>
...
<!-- embed video or image media-->
    ...
    <div class="section-credits content-wrapper">
        ...
        ?>
  			<div class="scalability-wrap">
  				<h3>
            <?php the_field('scalability_title'); ?>  
          </h3>
					<span class="proj-scalability">
            <?php the_field('scalability'); ?>  
          </span>
  			</div>
    		<?php
          } else {
        ...
        ?>
    		<div class="scalability-wrap">
	    		<h3><?php the_field('stewardship_title'); ?></h3>
  				<span class="proj-stewardship">
            <?php the_field('stewardship'); ?>    
          </span>
    		</div>
    			<?php
            } else {
