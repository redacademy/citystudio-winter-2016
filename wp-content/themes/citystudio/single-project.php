	...
	<main id="main" class="site-main" role="main">
		<?php while (have_posts()) : the_post(); ?>
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="project-hero" style="background: url('<?php the_field('banner_image'); ?>') no-repeat center center; background-size: cover; display: block;"></div>
								...
								<?php $value = get_field('activate_media'); ?>
									<?php if ($value) { ?>
										...
										<!-- linking media -->
											...
											<!-- file media upload -->
											<?php if (have_rows('project_media_2')); ?>
												<?php while (have_rows('project_media_2')) : the_row(); ?>
													<p class="media-links">
